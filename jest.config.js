...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '@bridge-ui/(((?!(legacy-preset-chart-deckgl|core/src)).)*)$':
      '<rootDir>/node_modules/@bridge-ui/$1/src',
    '@bridge-ui/core/src/(.*)$':
      '<rootDir>/node_modules/@bridge-ui/core/src/$1',
  },
  ...
  testPathIgnorePatterns: ['packages/generator-bridge/generators'],
  projects: [
    '<rootDir>',
    {
      displayName: 'node',
      rootDir: '<rootDir>/packages/generator-bridge',
