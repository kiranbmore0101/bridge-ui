...
export interface BridgeClientInterface
  extends Pick<
    BridgeClientClass,
    | 'delete'
    | 'get'
    ...
    | 'reAuthenticate'
  > {
  configure: (config?: ClientConfig) => BridgeClientClass;
  getInstance: (maybeClient?: BridgeClientClass) => BridgeClientClass;
  reset: () => void;
}

export type BridgeClientResponse = Response | JsonResponse | TextResponse;
