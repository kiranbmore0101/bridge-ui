...
declare module '@emotion/react' {
  ...
  export interface Theme extends BridgeTheme {}
}
...
export type BridgeTheme = typeof defaultTheme;

export interface BridgeThemeProps {
  theme: BridgeTheme;
}

export const bridgeTheme = defaultTheme;
