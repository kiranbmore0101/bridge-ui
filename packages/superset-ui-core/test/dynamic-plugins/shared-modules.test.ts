...
describe('shared modules', () => {
  ...
  it('assigns to window', async () => {
    ...
    expect((window as any)['__bridge__/test-module']).toStrictEqual(
      fakeModule,
    );
  });
  ...
  it('shares a map of modules', async () => {
    ...
    expect((window as any)['__bridge__/module-foo']).toEqual(foo);
    expect((window as any)['__bridge__/module-fizz']).toEqual(fizz);
  });
});
