...
import getTimeFormatterRegistry, {
  ...
  formatTimeRange,
} from '@bridge-ui/core/src/time-format/TimeFormatterRegistrySingleton';
import TimeFormatterRegistry from '@bridge-ui/core/src/time-format/TimeFormatterRegistry';
import { PREVIEW_TIME } from '@bridge-ui/core/src/time-format/TimeFormatter';
import {
  TimeGranularity,
  LOCAL_PREFIX,
} from '@bridge-ui/core/src/time-format';
