...
import CategoricalColorNamespace, {
  ...
  getColor,
  DEFAULT_NAMESPACE,
} from '@bridge-ui/core/src/color/CategoricalColorNamespace';
import getCategoricalSchemeRegistry from '@bridge-ui/core/src/color/CategoricalSchemeRegistrySingleton';
