...
import callApiAndParseWithTimeout from '@bridge-ui/core/src/connection/callApi/callApiAndParseWithTimeout';

// we import these via * so that we can spy on the 'default' property of the object
import * as callApi from '@bridge-ui/core/src/connection/callApi/callApi';
import * as parseResponse from '@bridge-ui/core/src/connection/callApi/parseResponse';
import * as rejectAfterTimeout from '@bridge-ui/core/src/connection/callApi/rejectAfterTimeout';
