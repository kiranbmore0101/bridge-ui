...
import { bigNumberFormData } from '@bridge-ui/core/test/chart/fixtures/formData';
...
export default {
  title: 'Core Packages/@bridge-ui-connection',
  decorators: [
    withKnobs({
      escapeHTML: false,
    }),
...
export const configureCORS = () => {
  const host = text('Bridge App host for CORS request', 'localhost:8088');
