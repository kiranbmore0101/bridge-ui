...
import { BigNumberChartPlugin as LegacyBigNumberPlugin } from '@bridge-ui/legacy-preset-chart-big-number';
import LegacySankeyPlugin from '@bridge-ui/legacy-plugin-chart-sankey';
import LegacySunburstPlugin from '@bridge-ui/legacy-plugin-chart-sunburst';
...
import {
  ...
  sunburstFormData,
  wordCloudFormData,
} from '@bridge-ui/core/test/chart/fixtures/formData';
...
export const dataProvider = () => {
  const host = text('Set Bridge App host for CORS request', 'localhost:8088');
