...
export default styled(NVD3)`
  .bridge-legacy-chart-nvd3-dist-bar, .bridge-legacy-chart-nvd3-bar {
  ...
  .bridge-legacy-chart-nvd3-tr-highlight {
    border-top: 1px solid;
    border-bottom: 1px solid;
    font-weight: ${({ theme }) => theme.typography.weights.bold};
  }
  .bridge-legacy-chart-nvd3-tr-total {
    font-weight: ${({ theme }) => theme.typography.weights.bold};
  }
  .nvtooltip {
    .tooltip-header {
