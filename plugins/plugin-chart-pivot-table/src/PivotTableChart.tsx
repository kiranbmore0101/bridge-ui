...
// @ts-ignore
import PivotTable from '@bridge-ui/react-pivottable/PivotTable';
import {
  sortAs,
  aggregatorTemplates,
  // @ts-ignore
} from '@bridge-ui/react-pivottable/Utilities';
import '@bridge-ui/react-pivottable/pivottable.css';
import { isAdhocColumn } from '@bridge-ui/chart-controls';
import {
  FilterType,
  MetricsLayoutEnum,
  PivotTableProps,
